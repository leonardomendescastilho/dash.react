          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell className="flex justify-end">{formatDistanceToNow(result.createdAt, {
                  locale: ptBR,
                  addSuffix: true,
                })}</TableCell>
              </TableRow>
          ...
          <Table>
            ...
            <TableFooter>
              <TableRow>
                ...
                <TableCell className="text-right font-medium">{(result.totalInCents / 100).toLocaleString('pt-BR', {
                  style: 'currency',
                  currency: 'BRL',
                })}</TableCell>
              </TableRow>
